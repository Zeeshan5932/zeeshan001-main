...
const projects: Project[] = [
  ...
  },
  {
    ...
    description: "A machine learning–based Sentiment Analysis application that analyzes Twitter text data and classifies user opinions as positive, negative, or neutral using Natural Language Processing.",
    longDescription: "This project is a Sentiment Analysis application built using Natural Language Processing and machine learning techniques. The model was trained on Twitter dataset to automatically classify tweets into positive, negative, or neutral sentiments. A simple frontend interface allows users to input text and instantly see the predicted sentiment generated by the trained model.",
    image: "https://images.unsplash.com/photo-1547954575-855750c57bd3?w=600&h=400&fit=crop",
    tech: ["Python", "Scikit-learn", "FastAPI", "React", "Docker"],
    features: ["Text sentiment prediction in real time", "Classifies text as positive, negative, or neutral", "NLP-based text preprocessing"],
    problem: "Understanding public opinion from large amounts of social media text is difficult and time-consuming when done manually.",
    solution: "This app automates sentiment detection by using an NLP-trained model on Twitter data, helping users quickly analyze emotions and opinions from text input.",
